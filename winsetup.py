...
setup(
    ...
    entry_points = {'console_scripts':[ 'botswebserver = bots.botswebserver:start',
                                        'botsengine = bots.botsengine:start',
                                        'botsgrammarcheck = bots.grammarcheck:start',
                                        #~ # #'bots-updatedb = bots.botsupdatedb:start',
                                        ],
                    },
    scripts = ["bots/postinstallation.py"],
    zip_safe=False,
    packages = packages,
