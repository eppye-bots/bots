...
listoferrortests = [
    ...
    {'infile':'ER03.edi','errortext':'''InMessageError: Edi file contains no valid envelopes (UNB-UNZ).'''},
    #~ #no UNB after UNZ
    {'infile':'ER04.edi','errortext':'''InMessageError: Found data at end of edi file, beyond the last valid envelope.'''},
    #~ #no UNZ (before another interchange)
    {'infile':'ER05.edi','errortext':'''InMessageError: Line:20 pos:1 record:"UNB": message has an error in its structure; this record is not allowed here. Scanned in message definition until mandatory record: "[['UNB'], ['UNZ']]". 	'''},
    #~ #no UNZ at end of file
    {'infile':'ER06.edi','errortext':'''InMessageError: Found no valid envelope trailer in edi file.'''},
    #~ #no UNH
    {'infile':'ER07.edi','errortext':'''	InMessageError: Line:2 pos:1 record:"BGM": message has an error in its structure; this record is not allowed here. Scanned in message definition until mandatory record: "[['UNB'], ['UNZ']]".'''},
    #~ #no BGM (M)
    {'infile':'ER08.edi','errortext':'''InMessageError: Line:3 pos:1 record:"DTM": message has an error in its structure; this record is not allowed here. Scanned in message definition until mandatory record: "[['UNH'], ['BGM']]". 	'''},
    #~ #unknown messagetype
    ...
    {'infile':'ER03.fix','errortext':'''InMessageError: Line:2 pos:0 record:"": message has an error in its structure; this record is not allowed here. Scanned in message definition until mandatory record: "[['HEA'], ['TOT']]".'''},
