...
class TestFormatFieldFixedOutmessage(unittest.TestCase):
    ...
    def test_out_fixedT(self):
        ...
        self.assertRaises(bots.botslib.MessageError,self.edi._formatfield,'1262',tfield1,testdummy,nodedummy)  # python allows 61 secnds?
...
class TestFormatFieldInmessage(unittest.TestCase):
    ...
    def test_in_T(self):
        ...
        self.assertRaises(bots.botslib.MessageError,self.edi._formatfield,'120062',tfield1,testdummy,nodedummy)  # python allows 61 secnds?
