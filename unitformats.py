...
class TestFormatFieldVariableOutmessage(unittest.TestCase):
    ...
    def test_out_formatfield_var_R(self):
        ...
        self.edi.ta_info['decimaal']='.'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1.234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1<3',tfield1,testdummy)    #wrong char
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1-3',tfield1,testdummy)    #'-' in middel of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123-',tfield1,testdummy)    #'-' at end of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1,3',tfield1,testdummy)    #',', where ',' is not traid sep.
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1+3',tfield1,testdummy)    #'+' in middle of number (no exp)
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1E3',tfield1,testdummy)    #'+' in middle of number (no exp)
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'13+',tfield1,testdummy)    #'+' at end
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0.100',tfield1,testdummy)   #field too big
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.',tfield1,testdummy)   #no num
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield1,testdummy)   #no num
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.001',tfield1,testdummy)   #bots adds 0 before dec, thus too big
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12345678E+3',tfield2,testdummy)   #too big with exp
        ...
        # self.assertRaises(botslib.MessageError,self.edi._formatfield,'12345678E-8',tfield2,testdummy)   #gets 0.12345678, is too big
        # self.assertRaises(botslib.MessageError,self.edi._formatfield,'12345678E+3',tfield2,testdummy)   #too big with exp
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-12345678',tfield2,testdummy) #field too large
    ...
    def test_out_formatfield_var_N(self):
        ...
        self.edi.ta_info['decimaal']='.'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1234.56',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1<3',tfield1,testdummy)    #wrong char
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1-3',tfield1,testdummy)    #'-' in middel of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123-',tfield1,testdummy)    #'-' at end of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1,3',tfield1,testdummy)    #',', where ',' is not traid sep.
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1E3',tfield1,testdummy)    #'+' in middle of number (no exp)
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'13+',tfield1,testdummy)    #'+' at end
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234.100',tfield1,testdummy)   #field too big
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.',tfield1,testdummy)   #no num
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield1,testdummy)   #no num
        # #test filling up to min length
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'178E+4',tfield2,testdummy)   #too big with exp
    ...
    def test_out_formatfield_var_I(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1+3',tfield1,testdummy)    #'+' in middle of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234.100',tfield1,testdummy)   #field too big
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.',tfield1,testdummy)   #no num
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield1,testdummy)   #no num
        #~ #test filling up to min length
    ...
    def test_out_formatfield_var_D(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'OOOOBC',tfield1,testdummy) #alfanum
    ...
    def test_out_formatfield_var_T(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12345678',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'240001',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'126101',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'120062',tfield1,testdummy) #no valid time - python allows 61 secnds?
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'240000',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'250001',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-12000',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'120',tfield1,testdummy) #no valid time
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0931233',tfield1,testdummy) #too short
        ...
        #                    length            decimals minlength 
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'230001',tfield2,testdummy) #time too long
        tfield3 = ['TEST1', 'M', 6,   'T', True,   0,      6,'T']
        #                    length            decimals minlength 
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'2300',tfield3,testdummy) #time too short
...
class TestFormatFieldFixedOutmessage(unittest.TestCase):
    ...
    def test_out_formatfield_fixedR(self):
        ...
        self.edi.ta_info['decimaal']='.'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.12',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-.12',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1.234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1<3',tfield1,testdummy)    #wrong char
    ...
    def test_out_formatfield_fixedN(self):
        ...
        self.edi.ta_info['decimaal']='.'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123.1049',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1234.56',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1<3',tfield1,testdummy)    #wrong char
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1-3',tfield1,testdummy)    #'-' in middel of number
    ...
    def test_out_formatfield_fixedT(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'11TIME',tfield2,testdummy) #alfanum
...
class TestFormatFieldInmessage(unittest.TestCase):
    ...
    def testformatfieldR(self):
        ...
        self.edi.ta_info['decimaal']='.'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0001',tfield1,testdummy) #leading zeroes; field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1.234',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1<3',tfield1,testdummy)    #wrong char
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1-3',tfield1,testdummy)    #'-' in middel of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1,3',tfield1,testdummy)    #',', where ',' is not traid sep.
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1+3',tfield1,testdummy)    #'+' in middle of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'13+',tfield1,testdummy)    #'+' in middle of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0.100',tfield1,testdummy)   #field too big
        #test field to short
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1235',tfield2,testdummy) #field too short
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-12.34',tfield2,testdummy) #field too short
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield2,testdummy) #field too short
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.',tfield2,testdummy) #field too short
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-.',tfield2,testdummy) #field too short
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12E+3',tfield2,testdummy) #field too large
    ...
    def testformatfieldN(self):
        ...
        #                    length            decimals minlength 
        #self.assertRaises(botslib.MessageError,self.edi._formatfield,'',tfield1,testdummy) #empty string
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1',tfield1,testdummy) #empty string
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0',tfield1,testdummy) #empty string
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-0',tfield1,testdummy) #empty string
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'01.00',tfield1,testdummy) #empty string
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'13+',tfield1,testdummy)    #'+' in middle of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'0.100',tfield1,testdummy)   #field too big
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12E+3',tfield1,testdummy)   #no exp
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'.',tfield1,testdummy)   #no exp
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield1,testdummy)   #no exp
        #test field to short
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123.4561',tfield4,testdummy) #to many digits
    ...
    def testformatfieldI(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123456',tfield1,testdummy) #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'000100',tfield1,testdummy)   #field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'000001',tfield1,testdummy) #leading zeroes; field too large
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12<3',tfield1,testdummy)    #wrong char
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12-3',tfield1,testdummy)    #'-' in middel of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12,3',tfield1,testdummy)    #','.
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12+3',tfield1,testdummy)    #'+' in middle of number
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'123+',tfield1,testdummy)    #'+'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12E+3',tfield1,testdummy)    #'+'
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-',tfield1,testdummy) #only -
        #~ #test field to short
        tfield2 = ['TEST1', 'M', 8,   'I', True,   2,      5,'I']
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'1235',tfield2,testdummy) #field too short
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'-1234',tfield2,testdummy) #field too short
        tfield3 = ['TEST1', 'M', 18,   'I', True,   0,      0,'I']
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'12E+3',tfield3,testdummy) #no exponent
        #~ #WARN: dubious tests. This is Bots filosophy: be flexible in input, be right in output.
    ...
    def testformatfieldA(self):
        ...
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'ab    ',tfield1,testdummy) 
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'    ab',tfield1,testdummy) 
        self.assertRaises(botslib.MessageError,self.edi._formatfield,' ',tfield1,testdummy) 
        self.assertRaises(botslib.MessageError,self.edi._formatfield,'',tfield1,testdummy) 
